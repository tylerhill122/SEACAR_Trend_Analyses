...
This markdown file is designed to be compiled by [Coral_PercentCover_ReportRender.R](https://github.com/FloridaSEACAR/SEACAR_Trend_Analyses/blob/main/Corals/Coral_PercentCover_ReportRender.R) (https://github.com/FloridaSEACAR/SEACAR_Trend_Analyses/blob/main/Coral/Coral_PercentCover_ReportRender.R).
...
Imports file that is determined in the Coral_PercentCover_ReportRender.R script.
...
```{r Trendlines_ManagedArea, warning=FALSE, fig.height=6, fig.width=8, results="asis"}
