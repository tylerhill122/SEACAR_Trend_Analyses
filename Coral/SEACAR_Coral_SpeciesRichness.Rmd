...
This markdown file is designed to be compiled by [SEACAR_CoastalWetlands_SpeciesRichness_ReportRender.R](https://github.com/FloridaSEACAR/SEACAR_Trend_Analyses/blob/main/Coral/SEACAR_Coral_SpeciesRichness_ReportRender.R) (https://github.com/FloridaSEACAR/SEACAR_Trend_Analyses/blob/main/Coral/SEACAR_Coral_SpeciesRichness_ReportRender.R).
...
Imports file that is determined in the SEACAR_Coral_SpeciesRichness_ReportRender.R script.
...
7. Sets perccov to be numeric values and removes rows where percent cover is 0
...
# Remove rows where perccov is 0 and missing
...
if(n==0){
   ...
   for (i in 1:n) {
      ...
      p1 <- ggplot(data=plot_data) +
         ...
         labs(title="Coral Species Richness",
