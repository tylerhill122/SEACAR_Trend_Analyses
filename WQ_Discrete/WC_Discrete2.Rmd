...
Here's some info about it, how cool
...
data_exclusion_table <- function(data, parameter) {
  ...
  data_excluded <- data %>% 
    ...
    select(ProgramID, ProgramName, ProgramLocationID, SampleDate, ResultValue, SEACAR_QAQCFlagCode, Include) %>%
    arrange(SampleDate)
