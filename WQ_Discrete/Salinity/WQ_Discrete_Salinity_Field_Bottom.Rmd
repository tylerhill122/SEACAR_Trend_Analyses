---
title: "SEACAR Discrete Water Quality Analysis: Field Bottom Salinity"
...
The purpose of this script is to analyze the discrete bottom salinity data measured in the field that is created from the SEACAR database, apply filtering criteria, create summary plots, and perform seasonal Kendall Tau analysis for each program location and summary statistics for values measured at the desired depth.
