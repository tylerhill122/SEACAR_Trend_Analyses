---
title: "SEACAR Discrete Water Quality Analysis: Lab Bottom Chlorophyll a Uncorrected for Pheophytin"
...
The purpose of this script is to analyze the discrete bottom chlorophyll a uncorrected for pheophytin data measured in the lab that is created from the SEACAR database, apply filtering criteria, create summary plots, and perform seasonal Kendall Tau analysis for each program location and summary statistics for values measured at the desired depth.
