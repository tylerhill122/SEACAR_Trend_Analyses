...
MA_Y_Stats <- as.data.table(MA_Y_Stats[order(MA_Y_Stats$ManagedAreaName,
                                             MA_Y_Stats$Year), ])
fwrite(MA_Y_Stats, paste0(out_dir,"/", param_name, "_", file_date, "-", depth,
...
MA_M_Stats <- as.data.table(MA_M_Stats[order(MA_M_Stats$ManagedAreaName,
                                             MA_M_Stats$Month), ])
fwrite(MA_M_Stats, paste0(out_dir,"/", param_name, "_", file_date, "-", depth,
...
fwrite(Mon_Stats, paste0(out_dir,"/", param_name, "_", file_date, "-", depth,
...
if(n==0){
   ...
   fwrite(KT.Stats, paste0(out_dir,"/", param_name, "_", file_date, "-", depth,
