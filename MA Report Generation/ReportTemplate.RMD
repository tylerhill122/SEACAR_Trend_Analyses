...
if(in_discrete){
  ...
  for (param in p_inc){
    ...
    plot_trendlines(param, activity, depth, activity_label, depth_label, y_labels, parameter, data, include_map=FALSE)
    ...
    plot_vq_barplot(param, activity, depth, activity_label, depth_label, y_labels, parameter, data, include_plot=FALSE)
...
```{r SAV scope_plots, warning=FALSE, results="asis", echo=FALSE, fig.height=20, fig.width=15}
...
```{r SAV maps, warning=FALSE, fig.height=6, fig.width=10, results="asis", eval=TRUE, echo=FALSE}
