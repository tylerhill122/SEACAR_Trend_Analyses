...
fwrite(data, paste0(out_dir,"/Nekton_", param_name, "UsedData_.txt"), sep="|")
...
```{r Trendlines_ManagedArea, warning=FALSE, fig.height=4, fig.width=8, results="asis", eval=APP_Plots}
plot_theme <- theme_bw() +
