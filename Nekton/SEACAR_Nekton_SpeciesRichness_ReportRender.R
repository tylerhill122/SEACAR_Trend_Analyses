...
#Renders SEACAR_Nekton_SpeciesRichness.Rmd and writes the report to a pdf and 
#Word document stored in output directory
file_out <-  paste0("SEACAR_Nekton_", param_file)

rmarkdown::render(input = "SEACAR_Nekton_SpeciesRichness.Rmd", 
